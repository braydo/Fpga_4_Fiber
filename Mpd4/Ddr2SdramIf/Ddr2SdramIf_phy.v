...
module Ddr2SdramIf_phy (
	...
	Ddr2SdramIf_phy_alt_mem_phy	Ddr2SdramIf_phy_alt_mem_phy_inst(
	...
	defparam
		...
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 1,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		...
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		Ddr2SdramIf_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 32,
		Ddr2SdramIf_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		Ddr2SdramIf_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		Ddr2SdramIf_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		Ddr2SdramIf_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		Ddr2SdramIf_phy_alt_mem_phy_inst.DEDICATED_MEMORY_CLK_EN = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="Ddr2SdramIf_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="Ddr2SdramIf_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="Ddr2SdramIf_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+Ddr2SdramIf_phy_alt_mem_phy_seq_wrapper;+Ddr2SdramIf_phy_alt_mem_phy_reconfig;+Ddr2SdramIf_phy_alt_mem_phy_pll;+Ddr2SdramIf_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/braydo/Projects/Fpga_4_Fiber/Mpd4/Ddr2SdramIf/Ddr2SdramIf_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: Ddr2SdramIf_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================
