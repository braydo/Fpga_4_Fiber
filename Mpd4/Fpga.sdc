...
# Input delays
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_A[*]}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_A[*]}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_D[*]}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_D[*]}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_AM[*]}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_AM[*]}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_WRITEb}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_WRITEb}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_DS*}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_DS*}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_ASb}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_ASb}]
set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_IACKb}]
set_input_delay -clock $Vme_Ref_Ck -min 1.0 [get_ports {VME_IACKb}]
#set_input_delay -clock $Vme_Ref_Ck -max 9.0 [get_ports {VME_IACKINb}]
...
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_D[*]}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_D[*]}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_IACKOUTb}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_IACKOUTb}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_DTACKb}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_DTACKb}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_BERRb}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_BERRb}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_RETRYb}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_RETRYb}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_IRQ[*]}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_IRQ[*]}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_DTACK_EN}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_DTACK_EN}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_BERR_EN}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_BERR_EN}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_RETRY_EN}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {VME_RETRY_EN}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {VME_LIOb}]
...
set_output_delay -clock $Apv_Ref_Ck -max 10.0 [get_ports {USER_OUT[0]}]
set_output_delay -clock $Apv_Ref_Ck -min 0.0 [get_ports {USER_OUT[0]}]
set_output_delay -clock $Apv_Ref_Ck -max 10.0 [get_ports {BUSY_OUT}]
set_output_delay -clock $Apv_Ref_Ck -min 0.0 [get_ports {BUSY_OUT}]
...
set_output_delay -clock $Apv_Ref_Ck -max 3.0 [get_ports {APV_TRIGGER}]
set_output_delay -clock $Apv_Ref_Ck -min -1.0 [get_ports {APV_TRIGGER}]
set_output_delay -clock $Vme_Ref_Ck -max 3.0 [get_ports {APV_RESET}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {APV_RESET}]

set_output_delay -clock $Vme_Ref_Ck -max 5.0 [get_ports {READ1}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {READ1}]
set_output_delay -clock $Vme_Ref_Ck -max 5.0 [get_ports {READ2}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {READ2}]

set_output_delay -clock $Vme_Ref_Ck -max 5.0 [get_ports {I2C_SDA_OUT}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {I2C_SDA_OUT}]
set_output_delay -clock $Vme_Ref_Ck -max 5.0 [get_ports {I2C_SCL}]
set_output_delay -clock $Vme_Ref_Ck -min -1.0 [get_ports {I2C_SCL}]

set_output_delay -clock $Vme_Ref_Ck -max 5.0 [get_ports {SPARE*}]
...
set_max_delay -from * -to {ADC_CONV_CK*} 5.0
set_max_delay -from * -to {USER_OUT[1]} 5.0
...
set_min_delay -from * -to {ADC_CONV_CK*} 0.0
set_min_delay -from * -to {USER_OUT[1]} 0.0
...
set_multicycle_path -from {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|ApvReadout:ApvFrameDecoder|n_channel[*]} -to \
    {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|ApvReadout:ApvFrameDecoder|computed_mean[*]*} -hold -end 1
...
set_multicycle_path -from {AdcDeser:AdcDeser*|AdcOneDeser:Deser*|int_PDATA[*]} -to \
    {AdcDeser:AdcDeser*|AdcOneDeser:Deser*|PDATA[*]} -hold -end 1
...
set_multicycle_path -from {fir_16tap:fir*|DATA_OUT[*]} -to {Histogrammer:AdcHisto*|RamAddr[*]} -hold -end 1
set_multicycle_path -from {VME_*} -to {VME_D*} -setup -end 3
set_multicycle_path -from {VME_*} -to {VME_D*} -hold -end 1
set_multicycle_path -from {VME_*} -to {VME_A*} -setup -end 3
set_multicycle_path -from {VME_*} -to {VME_A*} -hold -end 1
...
set_multicycle_path -from {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|FIFO_EMPTY} -to \
   {TrigGen:ApvTriggerHandler|hw_trig_enable} -hold -end 1
  ...
  set_multicycle_path -from {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|ApvReadout:ApvFrameDecoder|ApvDataFifo_1024x13:DataFifo|dcfifo:dcfifo_component|*} -to {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|BaselineSubtractorAndThresholdCut:ThrSub|word_count[*]} -hold -end 1
  ...
  set_multicycle_path -from {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|ApvReadout:ApvFrameDecoder|ApvDataFifo_1024x13:DataFifo|dcfifo:dcfifo_component|*} -to {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|BaselineSubtractorAndThresholdCut:ThrSub|fifo_out_wr	} -hold -end 1
  ...
  set_multicycle_path -from {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|ApvReadout:ApvFrameDecoder|DcFifo_32x12:MeanFifo|dcfifo:dcfifo_component|*} -to {EightChannels:ApvProcessor_*|ChannelProcessor:Ch*|BaselineSubtractorAndThresholdCut:ThrSub|word_count[*]} -hold -end 1
